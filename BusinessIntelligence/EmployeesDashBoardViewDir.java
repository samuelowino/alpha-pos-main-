...
public class EmployeesDashBoardViewDir extends JPanel {
    
    private static JButton viewItemButton;
    private static JLabel imageIconLabel;
    private static JLabel employeesLlabel;
    
    public EmployeesDashBoardViewDir(int x,int y){
        setSize(240,205);
        setLocation(x,y);
        ...
        imageIconLabel = new JLabel( new ImageIcon("C:\\Users\\user\\"
                + "NetBeansProjects\\PharmacyPOS\\src\\appimages\\Users-icon.png"));
        imageIconLabel.setBackground(Color.red);
        employeesLlabel = new JLabel("Employees DashBoard");
        
        
        viewItemButton.setBounds(0,160,80,45);
        employeesLlabel.setBounds(50,130,200,25);
        ...
        employeesLlabel.setFont( new Font("Calibri",Font.BOLD,16));
