...
public class CustomersDashBoardOptionPanel extends JPanel {
    
    private static JButton viewItemButton;
    private static JLabel imageIconLabel;
    private static JLabel customerLlabel;
    
    public CustomersDashBoardOptionPanel(int x,int y){
        setSize(240,205);
        setLocation(x,y);
        ...
        customerLlabel = new JLabel("Customers DashBoard");
        
        
        viewItemButton.setBounds(0,160,80,45);
        customerLlabel.setBounds(50,130,150,25);
        ...
        customerLlabel.setFont( new Font("Calibri",Font.BOLD,16));
