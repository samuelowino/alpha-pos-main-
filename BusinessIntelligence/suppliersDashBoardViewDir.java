...
public class suppliersDashBoardViewDir extends JPanel {
    
    private static JButton viewItemButton;
    private static JLabel imageIconLabel;
    private static JLabel suppliersLlabel;
    
    public suppliersDashBoardViewDir(int x,int y){
        setSize(240,205);
        setLocation(x,y);
        ...
        suppliersLlabel = new JLabel("Suppliers DashBoard");
        
        
        viewItemButton.setBounds(0,160,80,45);
        suppliersLlabel.setBounds(50,130,150,25);
        ...
        suppliersLlabel.setFont( new Font("Calibri",Font.BOLD,16));
