...
public class SalesDashBoardViewDir extends JPanel {
    
    private static JButton viewItemButton;
    private static JLabel imageIconLabel;
    private static JLabel salesLlabel;
    
    public SalesDashBoardViewDir(int x,int y){
        setSize(240,205);
        setLocation(x,y);
        ...
        salesLlabel = new JLabel("Sales DashBoard");
        
        
        viewItemButton.setBounds(0,160,80,45);
        salesLlabel.setBounds(50,130,150,25);
        ...
        salesLlabel.setFont( new Font("Calibri",Font.BOLD,16));
