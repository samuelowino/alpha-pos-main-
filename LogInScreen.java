...
import SystemSecurity.MD5Encryption;
...
public class LogInScreen extends JFrame {
    ...
    public LogInScreen(Boolean visible) {
        ...
        signInButton.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(null,"enterd pass"+String.valueOf(passwordField.getPassword()));
            JOptionPane.showMessageDialog(null,"DB passs"+UsersAuthentication.getUserPasswords().get(userNameField.getText())+"   Entered pass"+MD5Encryption.getCiphertext(String.valueOf(passwordField.getPassword())));
            try {
                if (!UsersAuthentication.getUserPasswords().get(userNameField.getText()).equals(String.valueOf(passwordField.getPassword()))) {
                    try {
                ...
                }else if(UsersAuthentication.getUserPasswords().get(userNameField.getText()).equals(MD5Encryption.getCiphertext(String.valueOf(passwordField.getPassword())))){
