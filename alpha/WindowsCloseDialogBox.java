...
public class WindowsCloseDialogBox extends JDialog {
    ...
    public WindowsCloseDialogBox(Boolean visible) {
        ...
        backgroundImageLabel = new JLabel(new ImageIcon("C:\\Users\\user\\NetBeansProjects\\PharmacyPOS\\src\\appimages\\22.jpg"));
        ...
        logOutButton.setBounds(30, 10, 200, 50);
        switchOffButton.setBounds(30, 100, 200, 50);
        settingsButton.setBounds(30, 200, 200, 50);
        ...
        List<JButton> buttons = Arrays.asList(
                logOutButton, switchOffButton, settingsButton, goButton
        );
        ...
        switchOffButton.addActionListener( e -> System.exit(0));
        settingsButton.addActionListener( e -> JOptionPane.showMessageDialog(null,"..."));
