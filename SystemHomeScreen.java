...
import static alpha.MainPOSInterface.inventoryViewPanel;
...
public class SystemHomeScreen extends JFrame {
    ...
    public SystemHomeScreen() {
        ...
        suppliersScanningButton.addActionListener( e -> {
            ...
            MainPOSInterface manInterface = new MainPOSInterface(true);
            manInterface.retrieveTableData("SELECT * FROM suppliers;", MainPOSInterface.suppliersModel, "Suppliers Table", "suppliers");
            MainPOSInterface.suppliersPatientTotalLabel.setText("Total: " + MainPOSInterface.suppliersModel.getRowCount() + "  Records Found");
        ...
        inventoryTrackingIconLabel.addActionListener(e -> {
            MainPOSInterface manInterface = new MainPOSInterface(true);
            manInterface.retrieveTableData("SELECT ID,name,purchasePrice,qty,sellPrice,Category,timeRemaining,Status,Details FROM drugs;", MainPOSInterface.stockTabelModel, "stocks Table", "drugs");
           ...
           //inventoryTotalLabel.setText("Total:" + MainPOSInterface.stockTabelModel.getRowCount() + "  Records Found");
        ...
        salesTrackingButton.addActionListener(event -> {
            MainPOSInterface mainInterface = new MainPOSInterface(true);
            mainInterface.retrieveTableData("SELECT * FROM salesInvoice;", MainPOSInterface.invoiceTableModel, "Inventory Table", "salesinvoice");
